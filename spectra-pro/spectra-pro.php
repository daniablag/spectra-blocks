...
$brainstrom['plugins']['spectra-pro']['status'] = 'registered';
$brainstrom['plugins']['spectra-pro']['purchase_key'] = 'registered';
update_option( 'brainstrom_products', $brainstrom );
function remove_bsf_license_notices() {
    remove_action( 'admin_notices', 'bsf_notices', 1000 );
    remove_action( 'network_admin_notices', 'bsf_notices', 1000 );
}
add_action( 'admin_head', 'remove_bsf_license_notices' );
